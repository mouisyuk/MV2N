...
function transformPackageConfig() {
  ...
  return {
    ...
    sitecoreSiteName:
      packageConfig.config.sitecoreSiteName || packageConfig.config.appName,
    defaultLanguage: packageConfig.config.language || "en",
    graphQLEndpointPath: packageConfig.config.graphQLEndpointPath || null,
    appLanguages: packageConfig.config.appLanguages || [
      packageConfig.config.language || "en",
    ],
  };
}
